        ...
        <div class="row hide-on-small-only">
            ...
            <div class="row"  style="min-height:55vh;">
                <div class="collection col l12 m12">
                    ...
                    <a href="dashboard.php" class="collection-item "><i class="material-icons">laptop</i> POS</a>

                    <a href="order.php" class="collection-item"><i class="material-icons">content_paste</i> Orders</a>

                       <a href="menu.php" class="collection-item active  blue darken-3"><i class="material-icons">import_contacts</i> Menu</a>
...
<br>
    ...
    <div class="nav-content">
      <ul class="tabs tabs-transparent">
        <li class="tab"><a href="#menu">ADD ITEM</a></li>
         <li class="tab"><a href="#menu">View ITEMS</a></li>
      </ul>
    </div>
  </nav>
                        </div>
...
<div id="menu"><?php include'menu/menu_tab.php'?></div>
